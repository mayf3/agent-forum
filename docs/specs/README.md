...
| `AGENT_FORUM_WORKFLOW_INSTANCE_CONTEXT_V1` | accepted in this candidate; effective after merge | implementation | `svc-forum` canonical WorkflowInstance context | contracts | — |
